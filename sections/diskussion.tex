...
Das Faszinierende an dieser Arbeit ist einmal zu sehen wie früher mithilfe von raffinierten Tricks verschiedene Filtertypen ohne Hilfe von Synthesetools synthetisiert werden konnten. Neben der billinearen und impulsinvarianten Transformation (die wir aus der digitalen Signalverebeitung kennen) ist uns nun auch die Richards Frequenztransformation und die Kuroda Transformation bekannt. Zu unserem Erstaunen haben diese beiden Transformationen trotz völlig unterschiedlichen Anwendungsgebieten sehr grosse Ähnlichkeiten. Zudem war es eine  wertvolle  und  interessante  Erfahrung,  neue  Software-Tools
kennenzulernen  (MWO  und  CST,  obwohl  CST  in  dieser  Arbeit  jetzt  nicht
eingesetzt wurde). Zuletzt muss aber auch noch gesagt werden, dass die Verfassung dieses Berichts sehr schwierig war, weil man sich bei dieser Thematik sehr schnell in den Details verlieren konnte.
